      ...
      <div className={classes["section-container"]}>
        <div className={classes["section-container--1"]}>
          ...
          <img
            ...
            alt="bird"
          />
          <h2>Krishna Bardoliya</h2>
          <h5>
            {/* <span>&#128231;</span> */}
            krishnabardoliya@gmail.com
          </h5>
          <div className={classes["section-container--1-icons"]}>
            <a
              href="https://www.linkedin.com/in/krishna-bardoliya/"
              target="_blank"
            >
              <img src={LinkedinIcon} alt="icon" />
            </a>
            <a href="https://github.com/krishnabardoliya" target="_blank">
              <img src={GithubIcon} alt="icon" />
            </a>
            {/* <a href="https://www.facebook.com/krishna-bardoliya" target="_blank">
