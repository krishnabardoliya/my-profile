    ...
    <header className={classes["header"]}>
      <div className={classes["header-container"]}>
        ...
        <div className={classes["header-container-heading--secondary"]}>
          ...
          {/* : Turning complexities into opportunities, one project at a time. */}
          </h2>
          <h2 className={classes["header-container-heading--secondary--2"]}>
          Chaos Coordinator!
          {/* : Turning disorder into productivity with a touch of magic. */}
          </h2>
          {/* <h2 className={classes["header-container-heading--secondary--3"]}>
          Digital Dreamweaver!
          : Crafting virtual realms with lines of code and a sprinkle of imagination.
          </h2> */}
          <h2 className={classes["header-container-heading--secondary--3"]}>
